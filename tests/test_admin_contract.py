...
class AdminContractTests(unittest.TestCase):
    def test_worker_has_private_routes_and_security_controls(self) -> None:
        ...
        for import_control in ("id=\"classNumber\"", "id=\"editPayload\"", "id=\"editOriginAddress\"", "id=\"blockEditor\"", "Weekly timetable", "Gap / free period", "body.class_number", "shortcut_url", 'alarm_label: "Shahaf"', "Shortcut URL (paste into Get Contents of URL)"):
