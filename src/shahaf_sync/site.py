    ...
    *,
    ...
    ui_translations = {
        "en": {
            ...
            "alarmTitle": "My alarm", "alarmButton": "Cancel / move my next alarm", "alarmInstruction": "This changes only this schedule’s next alarm. It will be applied after the next sync.",
            ...
            "alarmCancelQueued": "Next alarm cancellation is queued. Run the Shahaf Shortcut to apply it on the phone.", "alarmMoveQueued": "Next alarm move is queued. Run the Shahaf Shortcut to apply it on the phone.",
        ...
        "he": {
            ...
            "alarmTitle": "ההתראה שלי", "alarmButton": "ביטול / שינוי ההתראה הבאה שלי", "alarmInstruction": "פעולה זו משנה רק את ההתראה הבאה של המערכת הזו. השינוי יוחל לאחר הסנכרון הבא.",
            ...
            "alarmCancelQueued": "ביטול ההתראה הבאה הוכנס לתור. יש להפעיל את קיצור הדרך של שחף כדי להחיל אותו בטלפון.", "alarmMoveQueued": "שינוי ההתראה הבאה הוכנס לתור. יש להפעיל את קיצור הדרך של שחף כדי להחיל אותו בטלפון.",
