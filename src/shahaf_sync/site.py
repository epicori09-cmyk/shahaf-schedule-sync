    ...
    *,
    ...
    ui_translations = {
        "en": {
            ...
            "alarmTitle": "My alarm", "alarmButton": "Cancel / move my next alarm", "alarmInstruction": "This changes only this schedule’s next alarm. Restore puts it back to the correct original wake time, before any changes. Run the Shahaf Shortcut to apply it immediately; the full schedule sync continues in the background.",
        ...
        "he": {
            ...
            "alarmTitle": "ההתראה שלי", "alarmButton": "ביטול / שינוי ההתראה הבאה שלי", "alarmInstruction": "פעולה זו משנה רק את ההתראה הבאה של המערכת הזו. השחזור מחזיר אותה לשעת ההשכמה המקורית והנכונה, לפני כל שינוי. יש להפעיל את קיצור הדרך של שחף כדי להחיל מיד; סנכרון המערכת המלא ימשיך ברקע.",
