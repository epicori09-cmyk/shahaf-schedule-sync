    ...
    *,
    ...
    ui_translations = {
        "en": {
            ...
            "alarmTitle": "My alarm", "alarmButton": "Cancel / move my next alarm", "alarmInstruction": "This changes only this schedule’s next alarm. Run the Shahaf Shortcut to apply it immediately; the full schedule sync continues in the background.",
            "cancelTodayAlarm": "Cancel my next alarm", "moveAlarmTo": "Move my next alarm to", "moveAlarm": "Move alarm", "keepAlarm": "Keep current alarm",
            "alarmConfirmCancel": "Cancel this schedule’s next alarm?", "alarmConfirmMove": "Move this schedule’s next alarm to {time}?", "alarmSaving": "Saving next alarm change…",
            "alarmCancelQueued": "Next alarm cancellation is queued. Run the Shahaf Shortcut to apply it immediately.", "alarmMoveQueued": "Next alarm move is queued. Run the Shahaf Shortcut to apply it immediately.",
        ...
        "he": {
            ...
            "alarmTitle": "ההתראה שלי", "alarmButton": "ביטול / שינוי ההתראה הבאה שלי", "alarmInstruction": "פעולה זו משנה רק את ההתראה הבאה של המערכת הזו. יש להפעיל את קיצור הדרך של שחף כדי להחיל מיד; סנכרון המערכת המלא ימשיך ברקע.",
            "cancelTodayAlarm": "ביטול ההתראה הבאה שלי", "moveAlarmTo": "שינוי ההתראה הבאה שלי לשעה", "moveAlarm": "שינוי ההתראה", "keepAlarm": "השארת ההתראה הנוכחית",
            "alarmConfirmCancel": "לבטל את ההתראה הבאה של המערכת הזו?", "alarmConfirmMove": "לשנות את ההתראה הבאה של המערכת הזו לשעה {time}?", "alarmSaving": "שומר את שינוי ההתראה הבאה…",
            "alarmCancelQueued": "ביטול ההתראה הבאה הוכנס לתור. יש להפעיל את קיצור הדרך של שחף כדי להחיל מיד.", "alarmMoveQueued": "שינוי ההתראה הבאה הוכנס לתור. יש להפעיל את קיצור הדרך של שחף כדי להחיל מיד.",
