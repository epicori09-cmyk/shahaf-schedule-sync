    ...
    *,
    ...
    ui_translations = {
        "en": {
            ...
            "cancelTodayAlarm": "Cancel my next alarm", "moveAlarmTo": "Move my next alarm to", "moveAlarm": "Move alarm", "restoreAlarm": "Restore my alarm",
        ...
        "he": {
            ...
            "cancelTodayAlarm": "ביטול ההתראה הבאה שלי", "moveAlarmTo": "שינוי ההתראה הבאה שלי לשעה", "moveAlarm": "שינוי ההתראה", "restoreAlarm": "שחזור ההתראה שלי",
