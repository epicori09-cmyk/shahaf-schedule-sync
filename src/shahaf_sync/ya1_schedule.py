...
YA1_WEEKLY_SCHEDULE: tuple[tuple[int, int, str, str, str], ...] = (
    ...
    (6, 4, "היסטוריה", "לוי אושרי", "י״א 1–215"),
    (6, 7, "חינוך גופני", "דולב מיכל", ""),
    (6, 8, "ספרות", "ליקובסקי דנה", "י״א 1–215"),
    (6, 9, "אנגלית 5 יח״ל מואץ", "שפינל אירין", "י״א 2–217"),
    (6, 10, "הערכה חלופית – מדעי המחשב", "זכאי יצחק", "153 מעבדת מחשבים"),
    (6, 11, "הערכה חלופית – מדעי המחשב", "זכאי יצחק", "153 מעבדת מחשבים"),
    (6, 12, "הערכה חלופית – מדעי המחשב", "זכאי יצחק", "153 מעבדת מחשבים"),
